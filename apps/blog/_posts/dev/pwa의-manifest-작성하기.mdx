...
description: PWA(Progressive Web App)의 정보를 담은 Manifet 파일의 작성
date:
...
오브젝트엔 name, url, short\_name, description, icons가 포함되며 name과 url은 필수입니다.

* name - 표시될 이름(String)
* url - 클릭 시 이동할 주소(String)
* short\_name - 공간이 부족할 때 표시될 이름(String)
