...
앞서 작성했던 [VSCode를 Syntax Hihglighter로 쓰는 방법](/web/tips/vscode를-syntax-hihglighter로-쓰는-방법)에서 [cog25](https://github.com/cog25) 님이 [shiki](https://github.com/shikijs/shiki)라는 Syntax Highlighter를 추천해주셔서, 이를 이용해 온라인 구문 강조기를 제작해봤습니다.
