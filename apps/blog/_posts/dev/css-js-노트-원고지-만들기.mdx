...
description: CSS와 자바스크립트로 노트와 원고지에 글을 쓰는 느낌을 주는
date:
...
<iframe allowfullscreen="true" frameborder="0" width="560" height="560" src="https://codepen.io/marshall-ku/embed/jOVgeGg?default-tab=result" title="CSS Note" loading="lazy"></iframe>
...
<iframe allowfullscreen="true" frameborder="0" width="560" height="560" src="https://codepen.io/marshall-ku/embed/abBeREp?default-tab=result" title="Manuscript" loading="lazy"></iframe>
