...
군말 필요 없는 간단한 설치입니다.  
물론 [WSL](https://marshallku.com/web/tips/%ec%9c%88%eb%8f%84%ec%9a%b0%ec%97%90-%ec%9a%b0%eb%b6%84%ed%88%ac-%ec%84%a4%ec%b9%98%ed%95%98%ea%b8%b0)에서도 잘 돌아갑니다.
...
투명한 배경의 비디오 제작은 끝났고, 제가 예전에 제작한 [카메라 앱](https://marshallku.com/work/web-application/twice-%ec%9b%b9-%ec%b9%b4%eb%a9%94%eb%9d%bc)을 참고하시면 카메라에 접근해 canvas에 그릴 수 있습니다. 그 canvas 위에 다시 webm 비디오를 그리거나, webm 비디오의 z-index가 더 높게 표시되게 하면,
