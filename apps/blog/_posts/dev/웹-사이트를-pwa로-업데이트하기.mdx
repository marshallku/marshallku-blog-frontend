...
후술할 글을 통해 만든 PWA를 네이티브 앱으로 제작하시려면 [PWA를 스토어에 출시하기](/web/tips/pwa%eb%a5%bc-%ec%8a%a4%ed%86%a0%ec%96%b4%ec%97%90-%ec%b6%9c%ec%8b%9c%ed%95%98%ea%b8%b0)를 참고해주세요.
...
더 자세한 내용은 제 블로그의 [PWA의 Manifest 작성하기](/web/tips/pwa%ec%9d%98-manifest-%ec%9e%91%ec%84%b1%ed%95%98%ea%b8%b0)를 참고해주세요.
